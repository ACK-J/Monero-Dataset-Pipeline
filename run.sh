...
EOL
		...
		xfce4-terminal --tab -- /bin/bash -c "i=1; while : ;do ./${walletName}-spend.exp $(python3 -c "import random;sci=random.uniform(0.1, 0.000000000001);print(format(sci, \".12f\"))") $(python3 -c "import random;print(random.randrange(0,5))"); date; echo -en '\033[34mNumber of successful transactions: \033[0m'; echo \$i; ((i++)); python3 ../../Gamma.py;done"
		sleep 60
