...
EOL
		...
		xfce4-terminal --tab -x bash -c "while : ;do i=1; ./$walletName-spend.exp $(python3 -c 'import random;sci=random.uniform(0.01, 0.000000000001);print(format(sci, ".12f"))'); date; echo "\033[0;34Number of successful transactions: $i\033[0m'"; i=$((i+1)); python3 ../../Gamma.py;done"
		sleep 60
